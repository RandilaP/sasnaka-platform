...
function VolunteerApprovalTable() {
  ...
  return (
    <div className="mt-16 w-full p-9 ">
      <Link href="/dashboard">
        <Button className="" variant={"secondary"}>
          Back
        </Button>
      </Link>
      <Table className="w-2/3 mx-auto mt-4 ">
                  ...
                  <AlertDialogContent className="w-1/2">
                    <AlertDialogHeader>
                      <AlertDialogTitle className="flex w-full justify-between items-center text-center">
                        ...
                        <AlertDialogCancel className="w-9 h-9 border-none shadow-none rounded-full bottom-11">
                          <CircleX />
                        </AlertDialogCancel>
                      </AlertDialogTitle>
                        ...
                        <div className="p-4 flex flex-col space-y-2">
                          ...
                          <ul>
                            {volunteer.aesthetic_skills &&
                              volunteer.aesthetic_skills.map(
                                (skill: string) => (
